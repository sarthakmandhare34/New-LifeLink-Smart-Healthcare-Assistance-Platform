...
│  MySQL 8.x • Drizzle ORM 0.44       ││  Google Gemini 2.5 / 3.5 Flash   │
...
* **LLM Engine**: Google Gemini Flash API (`gemini-3.5-flash-lite`, `gemini-3.5-flash`, `gemini-3.7-flash`, etc.) invoked server-side only with strict JSON Schema generation.
* **Multi-Layer Safety Guardrails**: Biological validation, 0ms deterministic emergency regex overrides, adolescent/pediatric protections (<18), and non-medical input filters.
